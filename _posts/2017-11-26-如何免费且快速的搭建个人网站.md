...
```
Tips:
我的域名是www.aksyhdq.com，为了演示注册过程，显示未注册状态，所以这里以www.aksyhdq.com为例
```
...
文件名为CNAME；
内容为刚刚申请的域名www.aksyhdq.com
```
Tips:
没有www，表示解析到http://goileolee.top
请求流程为：
http://www.aksyhdq.comp --> http://bigBoyHua.github.io --> http://www.aksyhdq.com
```
至此，完成绑定！
...
```
<script>
    href="http://www.aksyhdq.com/u/0b1304c41418";
</script>
```
- 2、运用GitHub上开源的框架
